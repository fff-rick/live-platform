...
The gate is complete. With 1,000 active wallets and pool=40:

| Target TPS | Actual TPS | P99 | Peak InUse | Row-lock waits Δ |
|---:|---:|---:|---:|---:|
| 500 | 479.4 | 1.884 s | 40 | 7 |
| 1000 | 689.7 | 1.903 s | 40 | 23 |
| 1500 | 717.8 | 1.845 s | 40 | 24 |

The experiment removed almost all wallet-row contention while achieved throughput rose beyond the former ~500 TPS plateau. Throughput then flattened near ~700–720 TPS with the DB pool saturated. The limiting pressure therefore moved from wallet hotspots to DB-pool/transaction processing. M7 is frozen at this point; see `capacity.md` for the final distinction between low-latency operating point and saturation throughput.
